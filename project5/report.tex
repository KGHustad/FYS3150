...
The diffusion equation is used to describe so-called Brownian motion, where large systems of random microscopic particles is described by it's macroscopic characteristics. The quantity $u(\textbf{r},t)$ may be physically interpreted as, among other things, the particle density, energy density, or temperature gradient, at a given point in time and space.
\\\\
...
u(x,t) = 0, \quad 0 < x < L 
\end{equation}
while the boundry conditions of our system are
\begin{equation}
