...
\nabla^2 u(\textbf{r},t) = \frac{\pu(\textbf{r},t)}{\pt}
\end{equation}
Writing out the Laplace-operator, this becomes \ref{eqn:PDE} in one spatial dimension, and \ref{eqn:PDE2} in two spatial dimensions, where $x$, $y$, and $t$ now are dimensionless variables.
...
For the spatial derivative of the partial differential equation, we will be using the centred difference scheme, derived from a Taylor expansion in both directions around $u(x,t)$.
\begin{equation}
