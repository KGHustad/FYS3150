...
We wish to study numerical implementation of partial differential equations, using finite difference schemes. The partial differential equation we have chosen, is a simplified case of the diffusion equation, written as \ref{eqn:PDE} in one dimension, and \ref{eqn:PDE2} in two dimensions. The spatial derivatives on the left side will be approximated with central difference, and the time-derivative on the right using Forward Euler, Backward Euler, and the Crank-Nicolson scheme.
