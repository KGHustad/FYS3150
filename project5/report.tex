...
\subsection{error and stuff}

\begin{figure}[H]
\includegraphics[width=\textwidth]{fig/{FE_error_dx}.pdf}
\caption{Absolute error of Forward Euler scheme as function of dx.}
\label{fig:}
\end{figure}

\begin{figure}[H]
\includegraphics[width=\textwidth]{fig/{BE_error_dx}.pdf}
\caption{Absolute error of Forward Euler scheme as function of dx.}
\label{fig:}
\end{figure}
