...
In two dimensions, we see that different choices of boundary conditions along the top and bottom of the domain give quite different results. Disappointingly, we don't see much of a speedup when parallelizing our code.
