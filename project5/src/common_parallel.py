...
def diffusion_2d_parallel(v, f, iterations, kappa):
    #libdiffuse = load_lib()
    ...
    libdiffuse.solve_2d_parallel.restype = None
    libdiffuse.solve_2d_parallel.argtypes = [float64_array_2d,
                                            float64_array_2d,
                                            c_int,
                                            c_int,
                                            c_double,
                                            c_int,
                                            MPI_Comm]
    libdiffuse.solve_2d_parallel(#np.ctypeslib.as_ctypes(v),
