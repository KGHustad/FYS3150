...
Schroedingers equation for an electron in a three-dimentional harmonic oscillator well in spherical coordinates, ignoring the Coulomb force:
\begin{equation}
...
%\begin{figure}[ht]
%\includegraphics[width=\textwidth]{fig/plot_}
%\caption{Plotting ...}
%\end{figure}

\section{Conclusion}\label{sec:conclusion}
We see that decreasing the strength of the ocillator potential $\omega$ pushes the probability-distribution further away from 0, making it shallower. The same goes for the introduction of the Coulomb force.
