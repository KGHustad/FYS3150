...
We see that with the great Velocity Verlet integration method, the orbits quickly converge into a correct eliptical shape at timesteps as large as $\frac{1}{1000}$ of a year. Our code uses timesteps several orders of magnitude smaller than this agian, so we should expect rather accurate results.\\
