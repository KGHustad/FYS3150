...
\begin{equation}
\langle |M| \rangle = \frac{1}{2e^{-8\beta J} + 2e^{8\beta J} + 12} (16+8e^{-8\beta J}) = \frac{8+4e^{-8\beta J}}{e^{-8\beta J} + e^{8\beta J} + 6}
\end{equation}
...
\begin{equation}
\langle M^2 \rangle = \frac{1}{2e^{-8\beta J} + 2e^{8\beta J} + 12} (24) = \frac{12}{e^{-8\beta J} + e^{8\beta J} + 6}
\end{equation}
